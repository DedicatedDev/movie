...
export interface MovieQueryAllStoredMovieResponse {
...
export interface MovieStoredMovie {
  title?: string;
...
/**
 * @title movie/movie/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryStoredMovieAll
   * @summary Queries a list of StoredMovie items.
   * @request GET:/movie/movie/stored_movie
   */
  queryStoredMovieAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<MovieQueryAllStoredMovieResponse, RpcStatus>({
      path: `/movie/movie/stored_movie`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QueryStoredMovie
   * @summary Queries a StoredMovie by index.
   * @request GET:/movie/movie/stored_movie/{title}
   */
